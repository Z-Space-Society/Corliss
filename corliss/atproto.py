...
# scn-member-registry SPA has asked for exactly this granular form in
# production against stock Bluesky PDS software, which is what the applications
# now in the registry index were written with.
#
